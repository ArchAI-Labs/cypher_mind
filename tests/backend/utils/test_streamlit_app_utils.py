...
# Ora l'import funzionerà perché Python sa dove cercare il pacchetto 'backend'
from backend.utils.streamlit_app_utils import format_results_as_table, generate_sample_questions

# --- Tests for format_results_as_table ---
...
def test_generate_sample_questions_success():
    ...
    with patch.dict(os.environ, mock_env):
        with patch("builtins.open", mock_open(read_data=json.dumps(mock_json_content))) as mock_file:
